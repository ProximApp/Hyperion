...
def limiter(redis_client: redis.Redis[bytes], key: str, limit: int, window: int):
...
def locker_get(redis_client: redis.Redis[bytes], key: str):
...
def locker_set(redis_client: redis.Redis[bytes], key: str, lock: bool):
