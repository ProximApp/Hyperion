...
down_revision: str | None = "ca448cdee52b"
...
def upgrade() -> None:
    ...
    op.add_column("mypayment_structure", sa.Column("siret", sa.String(), nullable=True))
    op.add_column("mypayment_structure", sa.Column("iban", sa.String(), nullable=True))
    op.add_column("mypayment_structure", sa.Column("bic", sa.String(), nullable=True))
    op.add_column(
        "mypayment_structure",
        sa.Column("creation", TZDateTime(), nullable=True),
    )
    op.create_unique_constraint(None, "mypayment_structure", ["short_id"])
    conn = op.get_bind()
    conn.execute(
        sa.update(
            structure_table,
...
def downgrade() -> None:
    ...
    op.drop_column("mypayment_structure", "creation")
    op.drop_column("mypayment_structure", "bic")
    op.drop_column("mypayment_structure", "iban")
    op.drop_column("mypayment_structure", "siret")
    op.drop_column("mypayment_structure", "siege_address_country")
    op.drop_column("mypayment_structure", "siege_address_zipcode")
    op.drop_column("mypayment_structure", "siege_address_city")
    op.drop_column("mypayment_structure", "siege_address_street")
    op.drop_column("mypayment_structure", "short_id")
    op.drop_column("mypayment_store", "creation")
